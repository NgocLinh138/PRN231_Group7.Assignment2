    ...
    public class UsersController : Controller
    {
            ...
            int pageIndex = 1)
        {
            ...
            try
            {
                ...
                var url = $"http://localhost:5010/api/users?orderByAsc=true&pageIndex={pageIndex}&pageSize={this.pageSize}";
        ...
        private async Task<int> NumberOfItems(string searchValue)
        {
            ...
            var client = httpClientFactory.CreateClient();
            var url = $"http://localhost:5010/api/users?orderByAsc=true&pageIndex=1&pageSize=1000";
            if (!string.IsNullOrEmpty(searchValue))
